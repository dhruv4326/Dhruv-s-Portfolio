...
const EmailSection = () => {
  ...
  return (
    <section className='grid md:grid-cols-2  md:my-12 py-24 gap-24 relative'>
       <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary-900 to-transparent rounded-full h-80 w-80 z-10 blur-lg absolute top-3/4 -left-8 transform -translate-x-1/2 -translate-1/2"></div>
       <div className="z-10">
       <div >
        ...
        <form className='flex flex-col gap-6' ref={form} onSubmit={sendEmail}>
          ...
          <label
             htmlFor="email" 
            className='text-white block mb-2 text-sm font-medium'>Your Email
            </label>
          <input  
              type='email' 
              id='email' 
          ...
          <label
             htmlFor="Subject" 
            className='text-white block mb-2  text-sm font-medium'>Subject
            </label>
          <input  
              type='text' 
              id='subject' 
