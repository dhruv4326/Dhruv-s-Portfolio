...
const EmailSection = () => {
  ...
  <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary-900 to-transparent rounded-full z-10 blur-lg absolute top-2/3 -left-10 transform -translate-x-1/2 -translate-y-2/6 sm:h-48 sm:w-48 md:h-80 md:w-80"></div>

  {/* Content (Text and Social Links) */}
  <div className="z-0">
    <div>
